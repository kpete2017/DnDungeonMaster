<template>
    ...
    <ul class="navbar-nav">
      ...
      <li id="first" class="nav-item" @click="handleHomeClick()">
        ...
        <li class="nav-item" @click="handleNotesClick()">
            <a href="#" class="nav-link">
        ...
        <li class="nav-item" @click="handlePartyClick()">
            <a href="#" class="nav-link">
        ...
        <li class="nav-item" @click="handleNPCClick()">
            <a href="#" class="nav-link">
        ...
        <li class="nav-item" @click="handleMonsterClick()">
            <a href="#" class="nav-link">
        ...
        <li class="nav-item" @click="handleCompendiumClick()">
            <a href="#" class="nav-link">
